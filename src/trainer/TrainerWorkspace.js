  ...
  return (
    <div className='Workspace-container'>
      ...
      <button className="availability-button" onClick={() => navigate('/trainer-availability')}>
        <img
          src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRF0qyzh2NAlj84aeVcc2p6u_xGn4oiz4QQPw&s"
          alt="Availability"
